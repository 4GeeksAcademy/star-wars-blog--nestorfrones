            ...
            <div key={details.name} className="contaier">
                <div className="card mx-auto mt-5 d-flex flex-row">
                    ...
                    <div className="m-5 col">
                        ...
                        <p className="card-text p-1 m-1">Gender: {details.gender}</p>
                        <p className="card-text p-1 m-1">Heigth: {details.heigth}</p>
                        <p className="card-text p-1 m-1">Mass: {details.mass}</p>
                        <p className="card-text p-1 m-1">Skin Color: {details.skin_color}</p>
                    </div>
                </div>
            </div>
        </>
